...
public class paintJobEstimator {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= rooms; i++) {
			...
			laborHours += getHoursOfLabor(laborHours, gallons, HOURS_PER_GALLON);						// Get labor hours
	 ...
	 * @param laborHours
	 * @param gallons
	 * @param HOURS_PER_GALLON
	 * @return
	 */
	
	public static double getHoursOfLabor(double laborHours, double gallons, double HOURS_PER_GALLON) {
		
		// Calculation
		laborHours = gallons * HOURS_PER_GALLON;														// Hours required
		
		// Return
		return laborHours;																				// Retturns labor hours
	}
