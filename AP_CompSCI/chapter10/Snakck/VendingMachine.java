                            ...
                            implements ActionListener
{
  ...
  private JButton deposit25c, deposit10c, deposit5c, deposit1c, go;
    ...
    else if (b == go)
    {
      ...
      if (trayFull)          // Successful sale
      {
        ...
        JOptionPane.showMessageDialog(null,
          "Enjoy your " + brandName + "\n" + " Change: " + change + "C\n" +  coins.getQuarters() + " Quarters \n" +
          coins.getNickels() + " Nickels \n" + coins.getDimes() + " Dimes \n" + coins.getPennies() + " Pennies",
