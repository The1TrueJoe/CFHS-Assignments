                      ...
                      implements ActionListener
{
  ...
  public SnackBar()
  {
    ...
    ImageIcon coin = new ImageIcon("H:\\Eclipse Workspace\\APProgrammingChallenges\\chapter10\\Snakck\\coin.gif");

    Color brandColor1 = new Color(130, 30, 10); // r, g, b
    Color brandColor2 = new Color(255, 180, 0);
    Color brandColor3 = new Color(90, 180, 0);
    Color brandColor4 = new Color(0, 0, 0);
    ...
    VendingMachine[] machines =
    {
      ...
      new VendingMachine("Chocolate", brandColor4, 75, coin)
    };
    this.machines = machines;
    
    int w = machines.length * (250+5);
    int h = 310;
